...
<h2 class="section-heading">Executive Summary</h2>
  ...
  <p>Project Details:
  <ol>
    <li> Webscrape top-rated films and film information on IMDB and through OMDB API </li>
...
<br>
For more on the downsides of too much choice, check out Barry Schwartz's <a href="https://www.ted.com/talks/barry_schwartz_on_the_paradox_of_choice" target="_blank">TED Talk</a>. 
<br>
<br>
I'm not advocating a less is more approach because we are way past that point. But it never hurts to try and curate to everyone's idiosyncratic tastes. Just because you love Tarantino's films doesn't mean you will like all kinds of blood-soaked violence intermixed with incessent yet indelible dialogue. 
</p>
<div align = 'center'>  
    <a href="#">
      <img src="{{ site.baseurl }}/img/project-6/goodbad.jpg"></a>
</div>
