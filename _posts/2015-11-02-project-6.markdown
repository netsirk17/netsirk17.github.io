...
<p><b>What does this tell us? </b>
  Just because a film is highly rated (high ratings) does not mean it is necessarily popular (low number of ratings). Already we see a vulnerability in creating a better algorithm just by examining the top user-rated films.
</p>
